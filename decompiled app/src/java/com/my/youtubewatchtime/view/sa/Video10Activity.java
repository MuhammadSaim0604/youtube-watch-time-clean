...
public class Video10Activity extends AppCompatActivity {
    ...
    private void initialize(Bundle bundle) {
        this.vscroll2 = (ScrollView) findViewById(2131231238);
        this.linear43 = (LinearLayout) findViewById(2131230979);
        this.linear50 = (LinearLayout) findViewById(2131230987);
        ...
        this.linear48 = (LinearLayout) findViewById(2131230984);
        this.linear49 = (LinearLayout) findViewById(2131230985);
        ...
        this.webview19.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.2
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview21.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.3
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview22.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.4
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview24.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.5
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview25.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.6
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview26.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.7
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview27.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.8
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview28.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.9
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
        ...
        this.webview29.setWebViewClient(new WebViewClient() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.10
            @Override // android.webkit.WebViewClient
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
            }
    ...
    private void initializeLogic() {
        ...
        this.linear50.addView(banner);
        this.link = getIntent().getStringExtra("10");
    ...
    /* JADX WARN: Classes with same name are omitted:
      /storage/emulated/0/Documents/jadec/sources/com.my.youtubewatchtime.view.sa/dex-files/0.dex
     */
    /* renamed from: com.my.youtubewatchtime.view.sa.Video10Activity$11  reason: invalid class name */
    /* loaded from: /storage/emulated/0/Documents/jadec/sources/com.my.youtubewatchtime.view.sa/dex-files/2.dex */
    public class AnonymousClass11 extends TimerTask {
        ...
        public void run() {
            Video10Activity.this.runOnUiThread(new Runnable() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.11.1
                @Override // java.lang.Runnable
                public void run() {
                    new StartAppAd(Video10Activity.this).showAd(new AdDisplayListener() { // from class: com.my.youtubewatchtime.view.sa.Video10Activity.11.1.1
                        @Override // com.startapp.sdk.adsbase.adlisteners.AdDisplayListener
                        public void adDisplayed(Ad ad) {
                            SketchwareUtil.showMessage(Video10Activity.this.getApplicationContext(), "AD SHOW");
                        }

                        @Override // com.startapp.sdk.adsbase.adlisteners.AdDisplayListener
                        public void adClicked(Ad ad) {
                            SketchwareUtil.showMessage(Video10Activity.this.getApplicationContext(), "CLICK");
                        }

                        @Override // com.startapp.sdk.adsbase.adlisteners.AdDisplayListener
                        public void adHidden(Ad ad) {
                            SketchwareUtil.showMessage(Video10Activity.this.getApplicationContext(), "AD CLOSE");
                        }

                        @Override // com.startapp.sdk.adsbase.adlisteners.AdDisplayListener
                        public void adNotDisplayed(Ad ad) {
                            SketchwareUtil.showMessage(Video10Activity.this.getApplicationContext(), "AD Failed ");
                        }
                    });
                }
            });
