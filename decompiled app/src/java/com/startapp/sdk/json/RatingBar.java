...
public class RatingBar extends LinearLayout {
    private static Map<String, String> a = new HashMap<String, String>() { // from class: com.startapp.sdk.json.RatingBar.1
        {
    ...
    private void a(String str) {
        try {
            int a2 = t.a(getContext(), 2);
            int a3 = t.a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a4 = com.startapp.sdk.adsbase.j.a.a(getContext(), str);
            Bitmap bitmap = a4;
            if (a4 == null) {
                bitmap = c.a(a.get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(bitmap, t.a(getContext(), 15), t.a(getContext(), 15), true));
